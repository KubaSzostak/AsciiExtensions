// Based on andyraddatz code https://gist.github.com/andyraddatz/e6a396fb91856174d4e3f1bf2e10951c
// Modified by [Kuba Szostak](https://github.com/kubaszostak/AsciiExtensions)


using System.Diagnostics;
using System.Text; // IMPORTANT 
...
namespace System.Text.Ascii
{
    ...
    public static class AsciiExtensions
    {
        ...
        private static bool IsBetween(this char c, char first, char last)
        {
        ...
        public static char ToAscii(this char c, UnknownAsciiCharacters unknown)
        {
            if (c.IsBetween(' ', '~'))
            {
                // if it's an ASCII character then just keep current character
            ...
            switch (c)
            {
                ...
                case '\u018F': // Ə  [LATIN CAPITAL LETTER SCHWA]   http://en.wikipedia.org/wiki/Schwa
